...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
      ...
      <strong class="me-auto">Sistema de reservas</strong>
      <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
    </div>
    <div class="toast-body">
      <h6 class="text-center msjexito">Pasajero registrado con exito.</h6>
    </div>
  </div>
</div>
<?php } ?>
...
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="toast-body">
      <h6 class="text-center msjexito">Datos del Pasajero actualizados con exito.</h6>
    </div>
  </div>
</div>
<?php } ?>
...
if(isset($_REQUEST['deletPasajero'])){ ?>
<div class="position-fixed bottom-0 end-0 p-3" style="z-index: 11">
  <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    <div class="toast-header">
      <img src="imgs/logo.png" class="rounded me-2 logo" alt="Logo">
